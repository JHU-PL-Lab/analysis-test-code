...
public class OdefaMutualRecursionOnDynamicList3 {
    ...
    public static void main(String... args) {
        ...
        // allocate list of [false; false; false; ...]
        int len = 10;
        LinkedList<MyBoolean> list_2 = listMaker(f, len);
        ...
        MyBoolean result_2 = fun_f.apply(list_2);
